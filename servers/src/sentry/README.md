...
```
npx @ai-toolkit/inspector uvx mcp-server-sentry --auth-token YOUR_SENTRY_TOKEN
```
...
npx @ai-toolkit/inspector uv run mcp-server-sentry --auth-token YOUR_SENTRY_TOKEN
```
