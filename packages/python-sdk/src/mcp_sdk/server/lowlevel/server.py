...
from mcp_sdk.server.session import ServerSession
from mcp_sdk.server.stdio import stdio_server as stdio_server
from mcp_sdk.shared.context import RequestContext
from mcp_sdk.shared.exceptions import McpError
from mcp_sdk.shared.session import RequestResponder
...
class Server(Generic[LifespanResultT]):
    ...
    def create_initialization_options(
        ...
        return InitializationOptions(
            ...
            server_version=self.version if self.version else pkg_version("mcp-sdk"),
