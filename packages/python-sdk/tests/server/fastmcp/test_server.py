...
from mcp_sdk.server.fastmcp_sdk.prompts.base import (
    EmbeddedResource,
    Message,
    UserMessage,
)
from mcp_sdk.server.fastmcp_sdk.resources import FileResource, FunctionResource
from mcp_sdk.server.fastmcp_sdk.utilities.types import Image
...
if TYPE_CHECKING:
    from mcp_sdk.server.fastmcp import Context
...
class TestServer:
    ...
    async def test_create_server(self):
        ...
        assert mcp_sdk.name == "FastMCP"
        assert mcp_sdk.instructions == "Server instructions"
    ...
    async def test_non_ascii_description(self):
        ...
        async with client_session(mcp_sdk._mcp_server) as client:
    ...
    async def test_add_tool_decorator(self):
        ...
        assert len(mcp_sdk._tool_manager.list_tools()) == 1
    ...
    async def test_add_tool_decorator_incorrect_usage(self):
        ...
        with pytest.raises(TypeError, match="The @tool decorator was used incorrectly"):
            ...
            @mcp_sdk.tool  # Missing parentheses #type: ignore
            def add(x: int, y: int) -> int:
                return x + y
    ...
    async def test_add_resource_decorator(self):
        ...
        @mcp_sdk.resource("r://{x}")
        def get_data(x: str) -> str:
            return f"Data: {x}"

        assert len(mcp_sdk._resource_manager._templates) == 1
    ...
    async def test_add_resource_decorator_incorrect_usage(self):
        ...
        with pytest.raises(
            ...
            @mcp_sdk.resource  # Missing parentheses #type: ignore
            def get_data(x: str) -> str:
                return f"Data: {x}"
...
class TestServerTools:
    ...
    async def test_tool_exception_handling(self):
        mcp = FastMCP()
        mcp_sdk.add_tool(error_tool_fn)
        async with client_session(mcp_sdk._mcp_server) as client:
    ...
    async def test_tool_image_helper(self, tmp_path: Path):
        ...
        mcp = FastMCP()
        mcp_sdk.add_tool(image_tool_fn)
        async with client_session(mcp_sdk._mcp_server) as client:
    ...
    async def test_tool_mixed_content(self):
        mcp = FastMCP()
        mcp_sdk.add_tool(mixed_content_tool_fn)
        async with client_session(mcp_sdk._mcp_server) as client:
    ...
    async def test_tool_mixed_list_with_image(self, tmp_path: Path):
        ...
        mcp = FastMCP()
        mcp_sdk.add_tool(mixed_list_fn)
        async with client_session(mcp_sdk._mcp_server) as client:
...
class TestServerResourceTemplates:
    ...
    async def test_resource_with_params(self):
        ...
        with pytest.raises(ValueError, match="Mismatch between URI parameters"):
            ...
            @mcp_sdk.resource("resource://data")
    ...
    async def test_resource_with_uri_params(self):
        ...
        with pytest.raises(ValueError, match="Mismatch between URI parameters"):
            ...
            @mcp_sdk.resource("resource://{param}")
            def get_data() -> str:
                return "Data"
    ...
    async def test_resource_matching_params(self):
        ...
        @mcp_sdk.resource("resource://{name}/data")
    ...
    async def test_resource_multiple_params(self):
        ...
        @mcp_sdk.resource("resource://{org}/{repo}/data")
    ...
    async def test_resource_multiple_mismatched_params(self):
        ...
        @mcp_sdk.resource("resource://static")
    ...
    async def test_template_to_resource_conversion(self):
        ...
        assert len(mcp_sdk._resource_manager._templates) == 1
        assert len(await mcp_sdk.list_resources()) == 0

        # When accessed, should create a concrete resource
        resource = await mcp_sdk._resource_manager.get_resource("resource://test/data")
...
class TestContextInjection:
    ...
    async def test_context_detection(self):
        ...
        tool = mcp_sdk._tool_manager.add_tool(tool_with_context)
    ...
    async def test_context_injection(self):
        ...
        mcp_sdk.add_tool(tool_with_context)
        async with client_session(mcp_sdk._mcp_server) as client:
    ...
    async def test_context_logging(self):
        ...
        mcp_sdk.add_tool(logging_tool)

        with patch("mcp_sdk.server.session.ServerSession.send_log_message") as mock_log:
            async with client_session(mcp_sdk._mcp_server) as client:
...
class TestServerPrompts:
    ...
    async def test_prompt_decorator(self):
        ...
        prompts = mcp_sdk._prompt_manager.list_prompts()
    ...
    async def test_prompt_decorator_with_name(self):
        ...
        @mcp_sdk.prompt(name="custom_name")
        def fn() -> str:
            return "Hello, world!"
    ...
    async def test_prompt_decorator_with_description(self):
        ...
        @mcp_sdk.prompt(description="A custom description")
        def fn() -> str:
            return "Hello, world!"
