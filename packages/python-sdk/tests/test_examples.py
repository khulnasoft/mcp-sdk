...
from mcp_sdk.types import TextContent, TextResourceContents


@pytest.mark.anyio
async def test_simple_echo():
    """Test the simple echo server"""
    from examples.fastmcp_sdk.simple_echo import mcp
...
async def test_complex_inputs():
    ...
    from examples.fastmcp_sdk.complex_inputs import mcp
...
async def test_desktop(monkeypatch):
    ...
    from examples.fastmcp_sdk.desktop import mcp
